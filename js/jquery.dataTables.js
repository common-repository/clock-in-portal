...
(function (k) {
         ...
         function S(a, b, c, d) {
                  ...
                  if (l === q)
                           return (
                                    a.iDrawError != f &&
                                             null === h &&
                                             (aa(a, 0, "Requested unknown parameter " + ("function" == typeof e.mData ? "{function}" : "'" + e.mData + "'") + " for row " + b + ", column " + c, 4), (a.iDrawError = f)),
                                    h
                           );
                  ...
                  var p = function (x, r) {
                           ...
                           t = function (x) {
                                    if (c === q || c === h)
                                             (g = n[h]),
                                                      (l = x.innerHTML.trim()),
                                                      g && g._bAttrSrc ? (da(g.mData._)(d, l), p(g.mData.sort, x), p(g.mData.type, x), p(g.mData.filter, x)) : m ? (g._setter || (g._setter = da(g.mData)), g._setter(d, l)) : (d[h] = l);
                                    h++;
                           };
                  if (e)
                           for (; e; ) {
         ...
         function cc(a) {
                  ...
                  for (var d = 0, f = b.length; d < f; d++) {
                           ...
                           e.bSortable &&
                                    (0 < c.length && c[0].col == d ? (l.setAttribute("aria-sort", "asc" == c[0].dir ? "ascending" : "descending"), (e = g[c[0].index + 1] || g[0])) : (e = g[0]),
         ...
         function nb(a, b, c, d) {
                  ...
                  c && a.oFeatures.bSortMulti
                           ? ((c = k.inArray(b, T(f, "0"))),
                             -1 !== c ? ((b = g(f[c], !0)), null === b && 1 === f.length && (b = 0), null === b ? f.splice(c, 1) : ((f[c][1] = e[b]), (f[c]._idx = b))) : (f.push([b, e[0], 0]), (f[f.length - 1]._idx = 0)))
                           : f.length && f[0][0] == b
